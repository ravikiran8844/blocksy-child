...
<main>
    ...
    <section class="section4">
                                    ...
                                    <div class="rounded-3xl bg-[#F4F5F4] p-4 w-full shadow-md">
                                        <div class="grid gap-4 grid-cols-[40%_auto]">
                                            ...
                                            <div class="flex flex-col justify-between">
                                                ...
                                                <div>
                                                    <a class="text-sage border text-sm border-sage rounded-full px-4 py-2 flex gap-1 items-center w-fit"
                                                        href="#">Explore Now <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="py-8 md:py-12 lg:hidden mobile">
    ...
    <section class="bg-sage icon-with-text">
        <div class="ct-container py-4 md:py-6">
    ...
    <section class="ct-container py-8 md:py-12 lg:py-16 testimonials">
        <div class="text-center space-y-2 relative">
            <div class="text-2xl lg:text-3xl text-deep-forest italic lora">The love we got</div>
            <div class="flex gap-1 items-center absolute right-0 top-0 max-md:hidden">
                <button class="button-prev">
    ...
    <section class="instagram-section">
        <div class="ct-container py-8 md:py-12 lg:py-16">
            <div class="swiper mySwiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
