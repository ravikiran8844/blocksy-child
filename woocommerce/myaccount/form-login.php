...
<?php endif; ?>
	...
	<div class="text-2xl font-semibold text-center mb-4">
		...
		<div class="text-center mb-10"><?php echo apply_filters( 'woocommerce_login_message', esc_html__( 'Please log in to access your account.', 'woocommerce' ) ); ?></div>
		...
		<form class="woocommerce-form woocommerce-form-login" method="post" novalidate>
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				...
				<input placeholder="Username or email address" type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="username" autocomplete="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>" required aria-required="true" /><?php // @codingStandardsIgnoreLine ?>
			</p>
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
